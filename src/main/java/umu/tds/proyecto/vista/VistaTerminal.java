...
public class VistaTerminal {
	...
	public void codigo() {
		...
		while (true) {
			...
			String[] partes = linea.split("\\s+"); //\\s+ expresion regular que equivale a varios espacios juntos
			...
			try {
				...
				default:
					System.out.println("Orden erroenea. Use 'help' para ver ordenes permitidas.");
	...
	public void registrar() {
		...
		try {
			/* Lectura de cada propiedad de un movimiento, 
			   asegura que se pueda cancelar el registro en todo momento y que se pongan datos
			...
			*/
			...
			if (cuentaActual instanceof CuentaCompartida cuentaComp) {
				...
				//Imprimir los gastos disponibles
	...
	public void modificar() {
		...
		//Obtener he imprimir los gastos que se tienen hasta el momento
	...
	public void eliminar() {
		...
		//Si no se ha escrito ni 'n' ni 's', escribir hasta que se obtenga uno de los dos 
		else if (!confirmacion.equals("n") || !confirmacion.equals("s")) {
			while (true) {
				System.out.println("Respuesta invalida debe de ser 's' (Si) o 'n' (No):");
				confirmacion = scanner.nextLine();
				if (confirmacion.equals("n") || confirmacion.equals("s")) {
					break;
				}
			}
		}
